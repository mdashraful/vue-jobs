...
onMounted(async () => {
    try {
        ...
        form.type = state.job.type,
            ...
            form.company.contact_email = state.job?.company?.contactEmail,
            ...
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent="handelSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.contact_email" type="email" id="contact_email" name="contact_email"
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.contact_phone" type="tel" id="contact_phone" name="contact_phone"
